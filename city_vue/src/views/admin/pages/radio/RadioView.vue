    ...
    >
      <div class="container-fluid px-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <RouterLink to="/admin/radio/dashboard" class="tabs">
              <li
            ...
            <RouterLink to="/admin/radio/report" class="tabs">
              <li
                class="nav-item position-relative me-3 cursor-pointer"
            ...
            <RouterLink to="/admin/radio/focus" class="tabs">
              <li
                class="nav-item position-relative me-3 cursor-pointer"
                :class="{ active: navActive === 'focus' }"
                style="padding: 14px 8px"
                @click="navActive = 'focus'"
              >
                任務重點設定
              </li>
            </RouterLink>
